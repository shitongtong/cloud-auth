package cn.stt.cloud.auth.aspect;


import cn.stt.cloud.auth.util.SecurityUtils;
import cn.stt.cloud.auth.utils.StringUtils;
...
public class DaoAspect {
	...
	@Pointcut("execution(* cn.stt.cloud.*.mapper.*.update*(..))")
	public void daoUpdate() {
	}

	@Pointcut("execution(* cn.stt.cloud.*.mapper.*.insert*(..))")
